...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str, required=True, help='name of input image')
    parser.add_argument('-o', '--output', type=str, default='out.txt', required=False, help='name of output file (default: out.txt)')
